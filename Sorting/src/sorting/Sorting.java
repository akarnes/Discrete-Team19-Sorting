...
public class Sorting extends JFrame {
	...
	private int delay;	// The artificial delay between algorithm operations
	...
	public void check() {
		if(lastCheck == 0) {
			...
			dataColor[lastCheck] = Color.GREEN;
			Sound.play(300 + (int)(1000 * ((double) data[lastCheck] / (double) DATA_SIZE)));
			lastCheck++;
		} else {
...
//			g.drawRect(x, y, width, height);
		...
		g.drawString("Delay: " + delay + "ms", 600, 50);
